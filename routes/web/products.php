...
Route::get( '/products/generate-barcodes', [ ProductsController::class, 'generateBarcodes' ] )->name( ns()->routeName( 'ns.dashboard.products.generate-barcodes' ) );
Route::get( '/products/edit/{product}', [ ProductsController::class, 'editProduct' ] )->name( ns()->routeName( 'ns.dashboard.products.edit' ) );
